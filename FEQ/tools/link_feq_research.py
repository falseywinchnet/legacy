...
def main():
    ...
    if args.program == 'feq':
        ...
        sources.extend(['src/section_geometry.cpp','src/section_flux.cpp','src/section_properties.cpp','src/power.cpp',
                        ...
                        'src/culvert_loss.cpp','src/steady_residual.cpp','src/approach_residual.cpp','src/gate_residual.cpp','src/power_spacing.cpp','src/full_barrel.cpp','src/channel_rating.cpp',
                        'src/tailwater_residual.cpp','src/transition_energy.cpp','tools/geometry_compat.cpp','tools/flux_compat.cpp','tools/properties_compat.cpp'])
    if args.matrix_trace:
