...
C         correct type?
          ...
          IF(TYPE.NE.6.AND.TYPE.NE.13) THEN
...
C
      SUBROUTINE   TDLK15
     I                   (STDOUT, IP, MFTAB, TIME, EDA, EUA, HG, HBASE,
...
C     + + + DUMMY ARGUMENTS + + +
      ...
      REAL DQED, DQEU, EDA, EUA, HBASE, HG, NEWHG, Q, TIME
      CHARACTER FTYPE*8
...
C       point.
        CALL TDLK13
     I             (STDOUT, TAB2DR, 13, MFTAB, TIME, EDA, EUA, HBASE,
     O              Q, DQED, DQEU, FREE)
