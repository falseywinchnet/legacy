...
C     stored at address ADR and store in the reference level
C     slot for the table.
...
C     + + + EXTERNAL NAMES + + +
      EXTERNAL CHKTAB, FSBRAT, INL80, STRIP_L_BLANKS,
...
C     + + + EXTERNAL NAMES + + +
      INTEGER LENSTR
      CHARACTER GET_TABID*16
      EXTERNAL ETABIN, FRFEMB, INL120, INPRDP, KIL, SBFEMB, TWDOUT,
