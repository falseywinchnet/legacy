...
C     Called program units
      ...
      EXTERNAL INL80, CHKTAB, FMXARG, GETD, GET_ITEM_LIMITS,
...
C     + + + LOCAL VARIABLES + + +
     ...
     H     RG, RGFWUL, RMS, WORK(PMXFRC), XBRK(PMXNHU),  Y2FW,
...
C     + + + EXTERNAL NAMES + + +
      EXTERNAL CHKTAB, FDROOT, FINDCC, FNDELV, INL80,
