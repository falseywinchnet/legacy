...
C     External names
      EXTERNAL LENSTR, VAR_DECIMAL, PUT10, GET_TABID
...
C     + + + EXTERNAL NAMES + + +
      EXTERNAL INL120, OUTPUT_TYPE_234, PUT7, LENSTR, GET_TABID,
...
C         relationship as the head across the pump being a funciton
C         of flow.  
