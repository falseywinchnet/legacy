...
C     Local
     ...
     C         NUMBER, IDLENA, IDLENB, W1A, W2A
...
C     External names
      ...
      INTEGER LENSTR
      EXTERNAL CHKTAB, INL80, LSTOPF, TABCHK, TWDOUT, 
