...
C     + + + EXTERNAL NAMES + + +
      INTEGER LENSTR
      EXTERNAL INL80, KIL, GET_INTERNAL_TAB_NUMBER, LENSTR,
     A         STRIP_L_BLANKS
...
C     + + + LOCAL VARIABLES + + +
     ...
     A          SAVOPT*8, TYPE(PMXSUB)*10, TABID*16
...
C     + + + EXTERNAL NAMES + + +
      EXTERNAL CXSTAB, GETTOK, INL80, INL80B, MKBOX, MKPIPE, RHARCH, 
...
C     + + + EXTERNAL NAMES + + +
      INTEGER LENSTR
      EXTERNAL CXSTAB, INL80, INL80B, MKPIPE, SETMUD, SETOPT, TABCHK,
...
C      DO 1000 I=1,NPNTU
C        WRITE(STDOUT,90) XU(I), ZU(I), SBU(I), LSNU(I)
C90    FORMAT(F10.4,F10.4,I5, F10.4)
C1000  CONTINUE
C      WRITE(STDOUT,*) ' '
...
C     + + + OUTPUT FORMATS + + +
 ...
 62   FORMAT('0*WRN:511* NUMBER OF SIDES=',I3,' TOO SMALL.',
     A       ' NSIDES RESET TO 10')
 64   FORMAT('0*WRN:512* NUMBER OF SIDES=',I4,' TOO LARGE.',
     A       ' NSIDES RESET TO',I5)
 66   FORMAT('0*WRN:549* BETA OPTION MUST BE "OLDBETA".  THE OPTION',
     A   ' HAS BEEN RESET TO "OLDBETA".')
 68   FORMAT('0MUD LINE LEVEL=',F10.3)
 70   FORMAT('0MUD LINE N=',F10.3)
C***********************************************************************
C     ALLOW AUTOMATIC EXTENSION
