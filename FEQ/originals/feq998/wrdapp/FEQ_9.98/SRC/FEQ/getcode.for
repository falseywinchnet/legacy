...
C         Convert the second operand.  Must be an integer.
...
C     Local variables
     ...
     A        TERML(MAX_NVAL), TERMCLS(MAX_NVAL)
      ...
      CHARACTER CVAL(MAX_NVAL)*64, TERM(MAX_NVAL)*1, INSTRUCTION*16
...
C     floating point value.
     ...
     B        TERM_CLASS(MAX_KNT)
      ...
      CHARACTER ITEMS(MAX_KNT)*64, LINE_IN*112
