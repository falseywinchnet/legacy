...
C           Select the layer for Dummy branches
          ...
          ELSE
C           Output note to user input file for dummy branches not
C           drawn.
...
C     Local
     ...
     A        NULL
      ...
      DATA DNULL/-1.D30/, NULL/-2147483647/
C***********************************************************************
...
C     Local
      ...
      DATA NULL/-2147483647/, DNULL/-1.D30/
...
C     Called program units
     ...
     A        STRIP_ALL_BLANKS, DRAW_BRANCH_GRAPHIC
