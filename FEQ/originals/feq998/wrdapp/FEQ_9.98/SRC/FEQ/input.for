...
C     All values not set explicitly by user are at their default value.
     ...
     *      CD5T6_TAB_DATUM*4, NEW_GENSCN_FEO*4, GLB_HOME*64 
...
C     All values not set explicitly by user are at their default value.
     ...
     *      WSLOT, NSLOT, DWT, BWT, EXTTOL, SQREPS   
      ...
      CHARACTER BWFNAM*64, CHKGEO*4, ISTYLE*4,                                   
     *      GETIC*64, PUTIC*64
...
C     + + + SAVED VALUES + + +
     ...
     *CHAR,CHAR,CHAR,CHAR,CHAR,NUMERIC,NUMERIC,NUMERIC,CHAR/
     ...
     *EXACT,EXACT,EXACT,EXACT,EXACT,EXACT,EXACT,EXACT,EXACT,EXACT,
     *EXACT,EXACT,EXACT,EXACT,EXACT,LOWER,EXACT/
...
C     All values not set explicitly by user are at their default value.
      ...
      INTEGER NLUSE, NGAGE
      CHARACTER TSFNAM*64, FFFNAM*64, TABHOME*64
