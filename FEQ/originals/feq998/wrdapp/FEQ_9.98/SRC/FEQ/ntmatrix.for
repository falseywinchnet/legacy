...
C     EPSSYS - primary convergence limit one or more variables is
C              permitted to exceed the primary convergence limit
C     EPSSY2 - secondary convergence limit one or more variables is
C              permitted to exceed the primary convergence limit
...
C     Save copy of matrix and rhs for later dumping
      IF(START_EQ.LE.END_EQ.AND.
     A   JTIME.GE.PRTIME) THEN
