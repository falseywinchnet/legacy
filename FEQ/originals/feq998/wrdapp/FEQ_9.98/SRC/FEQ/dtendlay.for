...
C     They are set if detention is simulations
...
C     a tributary area unit
     ...
     C        LAST_DTA_PNT
      ...
      CHARACTER CVAL(ITEM_KNT)*64, TERM(ITEM_KNT)*1, WHICH*4
...
C     Local
     ...
     B        TERMCLS(MAX_ITEM_KNT)
      ...
      CHARACTER CVAL(MAX_ITEM_KNT)*64, TERM(MAX_ITEM_KNT)*1, LINE*113,
     A          LINE_ID*16
