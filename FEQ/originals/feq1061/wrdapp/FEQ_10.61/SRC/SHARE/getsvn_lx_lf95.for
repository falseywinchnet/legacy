...
52    format(';*WRN:XXX* The working copy contains local ',
     a 'modifications.', /,';',5x,
     a' The version number given is therefore',
...
54    format(';*ERR:XXX Working directory is under Subversion but',
     ...
     c '  Consult file:svn.zxcv_ in current working directory for',
     c ' details')
c***********************************************************************
      mflag = 0
      svn_rev = 0
