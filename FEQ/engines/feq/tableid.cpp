/* tableid.f -- translated by f2c (version 20240504).
...
/* SOURCE tableid.for:4 */
/*<       subroutinefind_internal_tab_number(tabid,internal_tab_number) >*/
/* Subroutine */ int feq_gen_find_internal_tab_number_d_(char *tabid, integer *
	feq_gen_internal_tab_number_d_, ftnlen tabid_len)
{
    extern /* Subroutine */ int lstab_(char *, char *, integer *, integer *, 
	    ftnlen, ftnlen);

/*     Given an id, try to find its internal table number, if none is found, */
/*     return 0 */
/* SOURCE tableid.for:10 */
/*<       implicitnone >*/
/* SOURCE tableid.for:11 */
/*<       integerinternal_tab_number >*/
/* SOURCE tableid.for:12 */
/*<       character*16tabid >*/
/* INCLUDE tableid.for:14 */
...
/* ****************************************************************************** */
/* SOURCE tableid.for:19 */
/*<       calllstab(tabid,tabid_table,num_tabid,internal_tab_number) >*/
    lstab_(tabid, tabidc_1.feq_gen_tabid_table_d_, &tabid_1.feq_gen_num_tabid_d_, 
	    feq_gen_internal_tab_number_d_, (ftnlen)16, (ftnlen)16);
/* SOURCE tableid.for:23 */
/*<       return >*/
    return 0;
/* SOURCE tableid.for:24 */
/*<       end >*/
} /* find_internal_tab_number__ */




/* SOURCE tableid.for:28 */
/*<        >*/
/* Subroutine */ int feq_gen_get_internal_tab_number_d_(integer *stdout, char *tabid, 
	integer *eflag, integer *feq_gen_internal_tab_number_d_, ftnlen tabid_len)
{
    extern /* Subroutine */ int lsatab_(integer *, char *, integer *, char *, 
	    integer *, integer *, integer *, ftnlen, ftnlen);

/*     Given a table id, find its internal table number and if none */
/*     is known, assign one. */
/* SOURCE tableid.for:35 */
/*<       implicitnone >*/
/* SOURCE tableid.for:36 */
/*<       integereflag,internal_tab_number,stdout >*/
/* SOURCE tableid.for:37 */
/*<       character*16tabid >*/
/* INCLUDE tableid.for:39 */
/*     DEFINITION OF PARAMETERS USED TO SET SIZE OF ARRAYS AND VECTORS */
/*     IN FEQ AND FEQUTL.  THIS FILE MUST BE INCLUDED IF ANY ARRAYS */
/*     OR VECTORS ARE BEING DECLARED IN A PROGRAM UNIT. */
...
/*<       common/tabidc/tabid_table >*/
/* ****************************************************************************** */
/* SOURCE tableid.for:44 */
/*<        >*/
    lsatab_(stdout, tabid, &feq_gen_c_d_10002, tabidc_1.feq_gen_tabid_table_d_, &
	    tabid_1.feq_gen_num_tabid_d_, feq_gen_internal_tab_number_d_, eflag, (ftnlen)16, (
	    ftnlen)16);
/* SOURCE tableid.for:48 */
/*<       return >*/
    return 0;
/* SOURCE tableid.for:49 */
/*<       end >*/
} /* get_internal_tab_number__ */




/* SOURCE tableid.for:53 */
/*<       character*16functionget_tabid(itabnum) >*/
/* Character */ VOID feq_gen_get_tabid_d_(char *ret_val, ftnlen ret_val_len, integer *
	itabnum)
{
    /* Builtin functions */
    /* Subroutine */ int s_copy(char *, char *, ftnlen, ftnlen);

/*     Get the table id from the symbol table given the internal table */
/*     number. */
/* SOURCE tableid.for:58 */
/*<       implicitnone >*/
/* SOURCE tableid.for:59 */
/*<       integeritabnum >*/
/* INCLUDE tableid.for:61 */
/*     DEFINITION OF PARAMETERS USED TO SET SIZE OF ARRAYS AND VECTORS */
/*     IN FEQ AND FEQUTL.  THIS FILE MUST BE INCLUDED IF ANY ARRAYS */
/*     OR VECTORS ARE BEING DECLARED IN A PROGRAM UNIT. */
...
/*<       common/tabidc/tabid_table >*/
/* ******************************************************************************* */
/* SOURCE tableid.for:65 */
/*<       if(itabnum.gt.0.and.itabnum.le.num_tabid)then >*/
    if (*itabnum > 0 && *itabnum <= tabid_1.feq_gen_num_tabid_d_) {
/* SOURCE tableid.for:66 */
/*<       get_tabid=tabid_table(itabnum) >*/
	s_copy(ret_val, tabidc_1.feq_gen_tabid_table_d_ + (*itabnum - 1 << 4), (ftnlen)
		16, (ftnlen)16);
/* SOURCE tableid.for:67 */
/*<       else >*/
    } else {
/* SOURCE tableid.for:68 */
/*<       get_tabid=' ' >*/
	s_copy(ret_val, const_cast<char*>(" "), (ftnlen)16, (ftnlen)1);
/* SOURCE tableid.for:69 */
/*<       endif >*/
    }
/* SOURCE tableid.for:70 */
/*<       return >*/
    return ;
/* SOURCE tableid.for:71 */
/*<       end >*/
} /* get_tabid__ */



/* SOURCE tableid.for:74 */
/*<       integerfunctionnonblank_nonzero(char16) >*/
integer feq_gen_nonblank_nonzero_d_(char *char16, ftnlen char16_len)
{
...
/*     Signal if the argument string is non-blank and if an */
/*     integer if it is non-zero as well.  The function value is */
/*     zero if the string contains all blanks or is  an */
/*     integer zero. */
/* SOURCE tableid.for:81 */
/*<       implicitnone >*/
/* SOURCE tableid.for:82 */
/*<       character*16char16 >*/
/*     Local */
/* SOURCE tableid.for:85 */
/*<       integeri >*/
/* ******************************************************************************* */
/* SOURCE tableid.for:88 */
/*<       nonblank_nonzero=0 >*/
    ret_val = 0;
/* SOURCE tableid.for:89 */
/*<       if(char16.ne.' ')then >*/
    if (s_cmp(char16, const_cast<char*>(" "), (ftnlen)16, (ftnlen)1) != 0) {
/*       Attempt to read as an integer */
/* SOURCE tableid.for:91 */
/*<       read(char16,'(I16)',err=100)i >*/
	...
	feq_gen_ici_d_1.icifmt = const_cast<char*>("(I16)");
	feq_gen_i_d_1 = s_rsfi(&feq_gen_ici_d_1);
	if (feq_gen_i_d_1 != 0) {
	    goto L100;
	}
	feq_gen_i_d_1 = do_fio(&feq_gen_c_d_1, (char *)&feq_gen_i_d_, (ftnlen)sizeof(integer));
	if (feq_gen_i_d_1 != 0) {
	    goto L100;
	}
...
/* SOURCE tableid.for:92 */
/*<       if(i.ne.0)then >*/
	if (feq_gen_i_d_ != 0) {
/* SOURCE tableid.for:93 */
/*<       nonblank_nonzero=1 >*/
	    ret_val = 1;
/* SOURCE tableid.for:94 */
/*<       endif >*/
	}
/* SOURCE tableid.for:95 */
/*<       goto110 >*/
	goto L110;
/* SOURCE tableid.for:96 */
/*<   100 continue >*/
L100:
/* SOURCE tableid.for:97 */
/*<       nonblank_nonzero=1 >*/
	ret_val = 1;
/* SOURCE tableid.for:98 */
/*<   110 continue >*/
L110:
/* SOURCE tableid.for:99 */
/*<       endif >*/
	;
    }
/* SOURCE tableid.for:100 */
/*<       return >*/
    return ret_val;
/* SOURCE tableid.for:101 */
/*<       end >*/
} /* nonblank_nonzero__ */
