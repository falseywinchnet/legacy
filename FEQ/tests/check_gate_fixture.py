...
mode={'gate_residual':'--gate','gate_levels':'--gate-levels','gate_free':'--gate-free',
      ...
      'tailwater_spacing':'--tailwater-spacing','channel_rating':'--channel-rating',
      'transition_factors':'--transition-factors','transition_energy':'--transition-energy',
      'transition_spacing':'--transition-spacing','critical_flow_limit':'--critical-limit',
      'ritter_wave':'--ritter-wave','ritter_section':'--ritter-section','ritter_residual':'--ritter-residual'}[kind]
