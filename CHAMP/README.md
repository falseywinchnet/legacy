# CHAMP, WHAFIS, and RUNUP — Legacy Coastal

Part of the [Legacy software collection](../README.md). This directory contains
the complete CHAMP project, its WHAFIS and RUNUP engines, and their original
software and recovery material.
...
Download the package for your computer from the [Legacy Coastal 0.1.0 release](https://github.com/falseywinchnet/legacy/releases/tag/v0.1.0).
...
Run the following from this `CHAMP/` directory (`cd CHAMP` first when starting
