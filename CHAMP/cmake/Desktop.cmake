...
if(APPLE)
  ...
  install(FILES LICENSE NOTICE.md DESTINATION "Legacy Coastal.app/Contents/Resources")
  install(FILES docs/DESKTOP.md DESTINATION "Legacy Coastal.app/Contents/Resources" RENAME README.md)
else()
  ...
  endforeach()
  install(FILES LICENSE NOTICE.md DESTINATION .)
  install(FILES docs/DESKTOP.md DESTINATION . RENAME README.md)
endif()
if(APPLE)
